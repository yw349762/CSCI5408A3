...
data = pd.read_csv('visitor/Pier21summer/2017Pier21vistorsummer.csv', sep=';', error_bad_lines=False)
...
with open('visitor/Pier21summer/out2017Pier21vistorsummer.csv', 'w') as outfile:
...
data = pd.read_csv('visitor/Pier21winter/2017Pier21vistorwinter.csv', sep=';', error_bad_lines=False)
...
with open('visitor/Pier21winter/out2017Pier21vistorwinter.csv', 'w') as outfile:
    writer = csv.writer(outfile)
    writer.writerow(["text","Sentiment","Score"])
