...
data = pd.read_csv('visitor/HalifaxHarboursummer/2017HalifaxHarbourvistorsummer.csv', sep=';', error_bad_lines=False)
...
with open('visitor/HalifaxHarboursummer/out2017HalifaxHarbourvistorsummer.csv', 'w') as outfile:
    writer = csv.writer(outfile)
    writer.writerow(["text","Sentiment","Score"])
...
data = pd.read_csv('visitor/HalifaxHarbourwinter/2013HalifaxHarbourvistorwinter.csv', sep=';', error_bad_lines=False)
...
with open('visitor/HalifaxHarbourwinter/out2013HalifaxHarbourvistorwinter.csv', 'w') as outfile:
    writer = csv.writer(outfile)
    writer.writerow(["text","Sentiment","Score"])
...
data = pd.read_csv('visitor/HalifaxHarbourwinter/2014HalifaxHarbourvistorwinter.csv', sep=';', error_bad_lines=False)
...
with open('visitor/HalifaxHarbourwinter/out2014HalifaxHarbourvistorwinter.csv', 'w') as outfile:
    writer = csv.writer(outfile)
    writer.writerow(["text","Sentiment","Score"])
